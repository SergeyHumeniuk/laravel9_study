const HTTP_SERVER="https://gadgetorio.solomono.net";const TEMPLATE_NAME="gadgetorio";const RENDER_TEMPLATE="templates/gadgetorio/render_template.php";const IS_MOBILE="0";const FACEBOOK_PIXEL_MODULE_ENABLED="1";const FACEBOOK_PIXEL_ID="";const DEFAULT_PIXEL_CURRENCY="USD";const RTPL_NUMBER_OF_ROWS="<input type=\"hidden\" name=\"number_of_rows\" value=\"%s\">";const RTPL_PAGES_HTML="<div class=\"pagination_list clearfix\">%s</div>";const RTPL_PRODUCTS_MODEL="<span class=\"label %s\">#<span>%s</span></span>";const RTPL_PRODUCTS_SPEC_PRICE="<span class=\"new_price\">%s</span><span class=\"old_price\">%s</span>";const RTPL_PRODUCTS_PRICE="<span class=\"new_price\">%s</span>";const RTPL_PRODUCTS_OLD_PRICE="<span class=\"old-price-label\">%s</span>";const RTPL_ADD_TO_CART_BUTTON_MODAL="<button type=\"submit\" class=\"btn btn-primary buy\">Buy</button>";const RTPL_PRODUCTS_COMPARE="<a data-id=\"%s\" class=\"compare_button\" href=\"#\"><input type=\"checkbox\" id=\"compare_%s\" name=\"compare_%s\" %s /><label for=\"compare_%s\"  data-toggle=\"tooltip\" data-placement=\"auto top\" title=\"Compare\">%s</label></a>";const RTPL_PRODUCTS_WISHLIST="<a data-id=\"%s\" class=\"wishlisht_button\" href=\"#\"><input type=\"checkbox\" id=\"wishlist_%s\" name=\"wishlist_%s\" %s /><label for=\"wishlist_%s\" data-toggle=\"tooltip\" data-placement=\"auto top\" title=\"To Wishlist\">%s</label></a>";const RTPL_COMPARE_OUTPUT="<div class=\"%s\">%s</div>";const RTPL_PRODUCTS_ATTR_LISTING_LIST="<li class=\"li_list\">%s: %s</li>";const RTPL_PRODUCTS_ATTR_LISTING_DEFAULT_VALUES="<input class=\"default_attribute\" type=\"hidden\" name=\"%s\" value=\"%s\">";const RTPL_PRODUCTS_ATTR_BODY_LIST="<div class=\"listing_attrs_list\"><ul class=\"ul_list\">%s</ul></div>";const RTPL_PRODUCTS_ATTR_LISTING_COL="<tr><td>%s:</td><td>%s</td></tr>";const RTPL_PRODUCTS_ATTR_BODY_COL="<table class=\"listing_attrs\">%s</table>";const RTPL_LISTING_HEADER="<div class=\"pdf_link\"><span class=\"btn-link\" data-href=\"%s\"><svg role=\"img\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 384 512\"><path d=\"M369.9 97.9L286 14C277 5 264.8-.1 252.1-.1H48C21.5 0 0 21.5 0 48v416c0 26.5 21.5 48 48 48h288c26.5 0 48-21.5 48-48V131.9c0-12.7-5.1-25-14.1-34zm-22.6 22.7c2.1 2.1 3.5 4.6 4.2 7.4H256V32.5c2.8.7 5.3 2.1 7.4 4.2l83.9 83.9zM336 480H48c-8.8 0-16-7.2-16-16V48c0-8.8 7.2-16 16-16h176v104c0 13.3 10.7 24 24 24h104v304c0 8.8-7.2 16-16 16zm-22-171.2c-13.5-13.3-55-9.2-73.7-6.7-21.2-12.8-35.2-30.4-45.1-56.6 4.3-18 12-47.2 6.4-64.9-4.4-28.1-39.7-24.7-44.6-6.8-5 18.3-.3 44.4 8.4 77.8-11.9 28.4-29.7 66.9-42.1 88.6-20.8 10.7-54.1 29.3-58.8 52.4-3.5 16.8 22.9 39.4 53.1 6.4 9.1-9.9 19.3-24.8 31.3-45.5 26.7-8.8 56.1-19.8 82-24 21.9 12 47.6 19.9 64.6 19.9 27.7.1 28.9-30.2 18.5-40.6zm-229.2 89c5.9-15.9 28.6-34.4 35.5-40.8-22.1 35.3-35.5 41.5-35.5 40.8zM180 175.5c8.7 0 7.8 37.5 2.1 47.6-5.2-16.3-5-47.6-2.1-47.6zm-28.4 159.3c11.3-19.8 21-43.2 28.8-63.7 9.7 17.7 22.1 31.7 35.1 41.5-24.3 4.7-45.4 15.1-63.9 22.2zm153.4-5.9s-5.8 7-43.5-9.1c41-3 47.7 6.4 43.5 9.1z\"></path></svg> PDF</span></div>";const RTPL_PDF_BLOCK_SELECTOR="#pdf_block span.btn-link";const RTPL_LISTING_HEADER_SLIDER="<div class=\"row row_catalog_products\"><div id=\"%s\" class=\"%s\" >";const RTPL_LISTING_HEADER_NORMAL="<div class=\"row row_catalog_products %s\" id=\"%s\" >";const RTPL_ARROW_LEFT="<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 512 512\"><path d=\"M217.9 256L345 129c9.4-9.4 9.4-24.6 0-33.9-9.4-9.4-24.6-9.3-34 0L167 239c-9.1 9.1-9.3 23.7-.7 33.1L310.9 417c4.7 4.7 10.9 7 17 7s12.3-2.3 17-7c9.4-9.4 9.4-24.6 0-33.9L217.9 256z\"></path></svg>";const RTPL_ARROW_RIGHT="<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 512 512\"><path d=\"M294.1 256L167 129c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.3 34 0L345 239c9.1 9.1 9.3 23.7.7 33.1L201.1 417c-4.7 4.7-10.9 7-17 7s-12.3-2.3-17-7c-9.4-9.4-9.4-24.6 0-33.9l127-127.1z\"></path></svg>";const RTPL_LISTING_ADD_FIELDS="a:1:{i:0;s:16:\"pd.products_info\";}";const RTPL_DEFAULT_COLS="[\"2\",\"2\",\"3\",\"4\",\"6\"]";const RTPL_PDF_ENABLED="1";const RTPL_LABEL="<div class=\"label%s product_label\">%s</div>";var hookie={};var page_name=document.getElementsByTagName('body')[0].getAttribute('data-page-name');var mainPageModules=[];var googleClientID='250888002462-f6jvfao2ahj313jdcm5cmpedm6tuh1os.apps.googleusercontent.com';var googleRedirectUri='https://gadgetorio.solomono.net/ext/auth/ajax_login_google.php';var timeoutValue=4000;var customizationPanelFlag=!1;var cPath=document.getElementsByTagName('body')[0].getAttribute('data-cpath');var searchKeywords=document.getElementById('searchpr')?document.getElementById('searchpr').value:'';var productPriceOrign=document.querySelector('input[name=prod_price_orign]')?document.querySelector('input[name=prod_price_orign]').value:'';var currentProductPrice=document.querySelector('input[name=prod_price]')?document.querySelector('input[name=prod_price]').value:'';var currentProductId=document.getElementById('products_id')?document.getElementById('products_id').value:'';var currentProductName=document.querySelector('input[name=prod_name]')?document.querySelector('input[name=prod_name]').value:'';var currentProductCategoryName=document.querySelector('input[name=prod_category_name]')?document.querySelector('input[name=prod_category_name]').value:'';
...
var c=String.fromCharCode(e.which);var n=parseInt(clone.val()+c);if((min&&n<min)||(max&&n>max)){e.preventDefault()}});self.replaceWith(group)})}}(jQuery));"use strict";function authModal(data){const body=document.querySelector("body");const modal_getLoginForm=document.getElementById("modal_getLoginForm");body.classList.add("modal-open");if(modal_getLoginForm)modal_getLoginForm.classList.add("hidden");body.innerHTML=`
...
function centerModal(el){$(el).css('display','block');var $dialog=$(el).find(".modal-dialog");$dialog.css('position','absolute');$dialog.css('top','50%');$dialog.css('left','50%');$dialog.css('transition','0.5s ease');$dialog.css('transform','translate(-50%, -70%)');$($dialog).animate({'margin-top':'100px'},1)}
...
function showCartpopup(){if(typeof window.settings!="undefined"){if(window.settings.SHOW_BASKET_ON_ADD_TO_CART==!0){$.get('./popup_cart.php',null,function(response){modal({id:'cart_popup',body:response,classes:'valign-false',after:function(){}})})}}}
function showPopupResponse(res){$('#popup_cart_form .delete').attr('disabled',!1);if(res!==undefined&&res!==0){res=JSON.parse(res);for(var i=0;i<res.prod.length;i++){var product_name=$('.row.cartContent_body.product_id_'+res.prod[i].string_id+res.prod[i].attr_chain+' .product_name');if(product_name.html()!=res.prod[i].name){product_name.html(res.prod[i].name)}
...
$('#cart_order_total').html(res.total);var warning_mess=$('.warning_mess');if(warning_mess.length>0){warning_mess.replaceWith(res.stock_text)}else{$('#cart_order_total').after(res.stock_text)}
if(res.stock_text!=''){$('#checkoutButton').css({'pointer-events':'none','opacity':'0.5'})}else{$('#checkoutButton').removeAttr("style")}}
...
currentProductId=data.id;productPriceOrign=data.price;currentProductCategoryName=data.category;currentProductName=data.name;doHookie('add2cart');showCartpopup();updateCart('add_product')},'json')}
...
setTimeout(function(){if($('input[name=prod_price]').val()!='-'){other_value=$('#id_option_other'+selected_op.val()).val();if((selected_op.attr('data-prefix')=='='||other_value.indexOf('=')==0)&&other_value!='=0'){summ=($('#id_option_other'+selected_op.val()).val()).substring(1)}else{$('.select_id_option').each(function(){sel_ops=$(this).parent().find($("select option:selected"));if(sel_ops.attr('data-prefix')=='='&&$('#id_option_other'+sel_ops.val()).val()!='=0'){summ=($('#id_option_other'+sel_ops.val()).val()).substring(1);return!1}});if(!summ)summ=parseFloat($('input[name=prod_price]').val())}
old_summ=parseFloat($('input[name=old_prod_price]').val());$('select.select_id_option').each(function(){if($(this).hasClass('selectized')){sel_ops=selectizeGetSelectedItem(selectizeWrapper($(this)));if(sel_ops.prefix){if(sel_ops.prefix=='+'||(sel_ops.prefix=='='&&$('#id_option_other'+sel_ops.value).val()=='=0')){summ=parseFloat(summ)+parseFloat(($('#id_option_other'+sel_ops.value).val()).substring(1));old_summ=parseFloat(old_summ)+parseFloat(($('#id_option_other'+sel_ops.value).val()).substring(1))}else if(sel_ops.prefix=='-'){summ=summ-parseFloat(($('#id_option_other'+sel_ops.value).val()).substring(1));old_summ=old_summ-parseFloat(($('#id_option_other'+sel_ops.value).val()).substring(1))}}}else{sel_ops=$(this).parent().find($("select option:selected"));if(sel_ops.attr('data-prefix')=='+'||(sel_ops.attr('data-prefix')=='='&&$('#id_option_other'+sel_ops.val()).val()=='=0')){summ=parseFloat(summ)+parseFloat(($('#id_option_other'+sel_ops.val()).val()).substring(1));old_summ=parseFloat(old_summ)+parseFloat(($('#id_option_other'+sel_ops.val()).val()).substring(1))}else if(sel_ops.attr('data-prefix')=='-'){summ=summ-parseFloat(($('#id_option_other'+sel_ops.val()).val()).substring(1));old_summ=old_summ-parseFloat(($('#id_option_other'+sel_ops.val()).val()).substring(1))}}});if($('#r_buy_intovar').length&&typeof attributeStock!="undefined"&&attributeStock&&attributeStock.length){var attrs=[],optionId='',optionValueId='';$('.prod_options [name="option_name"]').each(function(){optionId=$(this).val();if(optionId){optionValueId=$('[name='+optionId+']:checked').val();if(!optionValueId)optionValueId=$('#select_id_'+optionId).val();attrs[optionId]=optionId+'-'+optionValueId}});var attr=Object.keys(attrs).map(function(x){return attrs[x]}).join(',');if(typeof attributeStockPrice!="undefined"&&attributeStockPrice){if(typeof attributeStockSpecialPrice!="undefined"&&attributeStockSpecialPrice&&Object.values(attributeStockSpecialPrice).length&&attributeStockSpecialPrice[attr]){summ=attributeStockSpecialPrice[attr];old_summ=attributeStockPrice[attr];old_summ=parseFloat(old_summ)>parseFloat(summ)?old_summ:''}else{if(Object.values(attributeStockPrice).length&&attributeStockPrice[attr]){summ=attributeStockPrice[attr];old_summ=''}}}}
...
$("#r_spisok img").unveil(100,addAnimClassToImg);$('#loadMoreI').removeClass('fa-spin')},'json')}}
...
if(checkoutCheckAllTabs()||$('.warning_mess').length>0){$(checkoutButtonSelector).css({'pointer-events':'none','background':'#b5babe'})}else{$(checkoutButtonSelector).removeAttr("style")}}
...
$('.owl-carousel img').lazyload();jQuery('body').on('submit','form[name="cart_quantity"], form[name="modal_cart_quantity"]',function(event){event.preventDefault();doAddProduct(this)});jQuery('body').on('click','.add2cart',function(event){var $this=$(this);var product=$this.closest('.product');if(product.length&&product.hasClass('has_attributes')){var product_href=product.find(".p_img_href").attr('href');if(typeof product_href!='undefined'&&product_href!=''){window.location.href=product_href}}else{doAddProductList($this)}});jQuery('body').on('click','#checkoutButton',function(event){event.preventDefault();var href=jQuery(this).attr('href');jQuery("#popup_cart_form").ajaxSubmit({success:function(){showPopupResponse();window.location.href=href}})});jQuery('body').on('focus','input[name="cart_quantity[]"]',function(event){$(this).parent().next('.ok').fadeIn()});jQuery('body').on('change input','#popup_cart_form [name="cart_quantity[]"]',function(event){jQuery("#popup_cart_form").ajaxSubmit({success:showPopupResponse});var inputNumber=jQuery(this).siblings('.input-group').find('.inputnumber');inputNumber.val(Math.round(inputNumber.val()));var btnOk=$('#cartContent-page .btn.ok');for(var i=0;i<btnOk.length;i++){btnOk[i].style.display='none'}});jQuery(document).on('shown.bs.dropdown','#divShoppingCard',function(event){event.preventDefault();$.get('./popup_cart.php',null,function(response){$('#new_basked_block').html(response)})});jQuery(document).on('change','#new_basked_block input[name="cart_quantity[]"]',function(event){jQuery("#popup_cart_form").ajaxSubmit({target:'#new_basked_block',success:function(){$.post('./ajax_update_cart.php','',function(data){$('.quantity_basket,.mobile_cart_count').html(data.cart_count);$.get('./popup_cart.php',null,function(response){$('#new_basked_block').html(response)})},'json')}})});jQuery('body').on('click','#popup_cart_form .delete',function(event){$(this).parent().find($('input[name="cart_delete[]"]')).attr('checked','checked');if(jQuery("#popup_cart_form .delete").length==1){jQuery("#popup_cart_form").animate({opacity:0},200,function(){jQuery("#modal_cart_popup .modal-body").animate({height:jQuery("#modal_cart_popup .modal-body").height()-163},200,function(){jQuery("#popup_cart_form").ajaxSubmit({target:'#modal_cart_popup .modal-body',success:showPopupResponse})})})}else{var skipTemplates=['gadgetorio','solo_cellphones','solo_health'];jQuery('#popup_cart_form .delete').attr('disabled',!0);jQuery(this).parent().parent().parent().parent().slideUp(200,function(){if(jQuery.inArray(TEMPLATE_NAME,skipTemplates)!=-1){jQuery("#popup_cart_form").ajaxSubmit({target:'#modal_cart_popup .modal-body',success:showPopupResponse})}else{jQuery("#popup_cart_form").ajaxSubmit({success:showPopupResponse});jQuery(this).remove()}})}
var _vall=$(this).attr('data-clearpid');$('.added2cart[data-id='+_vall+']').replaceWith(sprintf(RTPL_ADD_TO_CART_BUTTON,_vall));$("#r_buy_intovar[data-id="+_vall+"]").html(RTPL_ADD_TO_CART_BUTTON_PRODUCT_PAGE)});jQuery(document).on('submit','.form_subscribe_news',function(event){event.preventDefault();doHookie('subscribe');var this_form=$(this);$.post($(this).attr('action'),$(this).serialize(),function(response){this_form.trigger("reset");modal({id:'subscribe',body:response.message,render:!0,after:function(modal){setTimeout(function(){modal.modal('hide')},3500)}})},'json')});jQuery(document).on('submit','[name="contact_us"]',function(event){event.preventDefault();doHookie('contact_us');var this_form=$(this);$.post($(this).attr('action'),$(this).serialize(),function(response){$('[name="_csrf"]').val(response.csrf);if(response.status!='fail'){this_form.trigger("reset");if(typeof grecaptcha==='object'){grecaptcha.reset()}}
modal({id:'ContactUs',body:response.msg,render:!0,after:function(modal){}})},'json')});jQuery('body').on('click touchstart','.popup_cart',function(event){event.preventDefault();if($('[data-dismiss="modal"]')){$('[data-dismiss="modal"]').click();setTimeout(function(){showCartpopup()},300)}else{showCartpopup()}});jQuery('body').on('click','.article-alert .close',function(event){event.preventDefault();setCookie('article_alert_showed','1',1)});jQuery('.call_us_btn').click(function(e){e.preventDefault();pop_contact_us()});$('#user-login-dropdown .dropdown-menu').on('click',function(event){event.stopPropagation()});$(document).ready(function(){if($(window).width()>768){$('[data-toggle="tooltip"]').tooltip({container:'body'})}
jQuery('body').on('click','.show_search_form',function(){openSearchForm();$('.close-mobile-search').toggleClass('d-none');$('.open-mobile-search').toggleClass('d-none')});$(document).on('click','#search-form-button-close, #search-form-button-close1',function(){closeSearchForm()});$(document).on('click','#search-form-fader',function(){closeSearchForm()});$(window).on("scroll",function(){var stickyPosition=Math.abs(parseInt($('header').css('top'),10));if($(this).scrollTop()>stickyPosition){$('header').addClass('header_shadow')}else{$('header').removeClass('header_shadow')}});$('.hover .dropdown-menu').on("click",function(e){e.stopPropagation()});if($(window).width()>=992){$("#user-login-dropdown").mouseenter(function(){}).mouseleave(function(){});$(".dropdown-hover").mouseenter(function(){$(this).addClass('open')}).mouseleave(function(){$(this).removeClass('open')})}
...
$(document).on('click','.ajax_modal_article',function(e){e.preventDefault();$.post('./ajax_modal_article.php',{article_id:$(this).attr('data-id')},function(data){modal({id:'ajax_modal_article',title:data.articles_name,body:data.articles_description})},'json')});$('#shoprules').click(function(e){var el='form[name=create_account] input[type=submit]';if($(el).hasClass('active_submit'))$(el).removeClass('active_submit');else $(el).addClass('active_submit')});$('.main_nav > ul').prepend('<li class="mobile"></li>');$('.toggle_nav').click(function(e){if($('.main_nav li').hasClass('mobile')){e.preventDefault();$('.main_nav').toggleClass('expand')}});$('.main_nav li > a').click(function(e){$('.main_nav li').removeClass('active_page');$(this).closest('li').addClass('active_page')});if(typeof tabs!='undefined'){$('.tabs').tabs()}
...
$(document).on('click','.googleSigninButton',startGoogleOAuth);'use strict';function addHookie($key,$value,$sortOrder=10){if(typeof hookie!='undefined'){if(typeof hookie[$key]!='object'){hookie[$key]={}}
if(typeof hookie[$key][$sortOrder]!='object'){hookie[$key][$sortOrder]=[]}
hookie[$key][$sortOrder].push($value)}}
function doHookie($key){if(typeof hookie=='object'&&typeof hookie[$key]=='object'){for(let sortOrder in hookie[$key]){if(hookie[$key][sortOrder].length>0){for(let index in hookie[$key][sortOrder]){try{eval(hookie[$key][sortOrder][index]);console.log(hookie[$key][sortOrder][index])}catch(e){console.log(e)}}}}}};jQuery.autocomplete=function(input,options){var me=this;var currentRequest=null;var $input=$(input).attr("autocomplete","off");if(options.inputClass)$input.addClass(options.inputClass);var results=document.createElement("div");var $results=$(results);$results.hide().addClass(options.resultsClass).css("position","absolute");if(options.width>0)$results.css("width",options.width);$("body").append(results);input.autocompleter=me;var timeout=null;var prev="";var active=-1;var cache={};var keyb=!1;var hasFocus=!1;var lastKeyPressCode=null;function flushCache(){cache={};cache.data={};cache.length=0};flushCache();if(options.data!=null){var sFirstChar="",stMatchSets={},row=[];if(typeof options.url!="string")options.cacheLength=1;for(var i=0;i<options.data.length;i++){row=((typeof options.data[i]=="string")?[options.data[i]]:options.data[i]);if(row[0].length>0){sFirstChar=row[0].substring(0,1).toLowerCase();if(!stMatchSets[sFirstChar])stMatchSets[sFirstChar]=[];stMatchSets[sFirstChar].push(row)}}
...
return-1};jQuery('body').on('click',function(e){if(jQuery(e.target).parents('.ac_results').length==0){jQuery('.ac_results').hide()}});var id_search=$("#searchpr").attr('id');$("#searchpr").autocomplete("ajax_search.php",{resultsClass:"ac_results "+id_search,delay:200,minChars:2,matchSubset:1,autoFill:!1,matchContains:1,cacheLength:10,selectFirst:!0,formatItem:liFormat,maxItemsToShow:8,onItemSelect:selectItem});$("#searchpr1").autocomplete("ajax_search.php",{delay:200,minChars:2,matchSubset:1,autoFill:!1,matchContains:1,cacheLength:10,selectFirst:!0,formatItem:liFormat,maxItemsToShow:8,onItemSelect:selectItem});jQuery('body').ready(function(){function initScrollBar(selector,autoHide){$(selector).each(function(){new SimpleBar($(this)[0],{autoHide:autoHide})})}
$('#categories-slider').owlCarousel({loop:!1,margin:40,nav:!0,navText:['<svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path d="M34.52 239.03L228.87 44.69c9.37-9.37 24.57-9.37 33.94 0l22.67 22.67c9.36 9.36 9.37 24.52.04 33.9L131.49 256l154.02 154.75c9.34 9.38 9.32 24.54-.04 33.9l-22.67 22.67c-9.37 9.37-24.57 9.37-33.94 0L34.52 272.97c-9.37-9.37-9.37-24.57 0-33.94z"></path></svg>','<svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z"></path></svg>'],pagination:!1,responsive:{0:{items:3},600:{items:5},1000:{items:7}}});var wideSlider=$(".categories-mainpage");var sliderStage=wideSlider.find(".owl-stage").width();var sliderOuterStage=wideSlider.find(".owl-stage-outer").width();if(sliderStage<=sliderOuterStage){wideSlider.find('.owl-controls').hide()}
$('#shoprules').click(function(e){var el='form[name=create_account] input[type=submit]';if(!$(el).hasClass('active_submit')){$(el).addClass('active_submit')}});$('.open-menu-xs').click(function(e){$('body').toggleClass('no-scroll-y');$('.header-categories').toggleClass('header-categories-animate');$(this).find('.fader').toggleClass('fader-menu-animate')});$('.dropdown-submenu').click(function(e){});function wishlistCompare_xs(e){if($(e).parent().hasClass('wc-box-hovered')){$(e).parent().removeClass('wc-box-hovered')}else{$(e).parent().addClass('wc-box-hovered')}}
$(document).on('click','#wishlist_box2 .wishlist-icon',function(e){wishlistCompare_xs(this)});$(document).on('click','#compare_box .compare-icon',function(e){wishlistCompare_xs(this)});if($(window).width()<=767){$('a.submenu.level-0').on('click',function(e){e.preventDefault();$(this).next('.submenu-list').toggleClass('opened')});$('.section_top_footer .h3, .contacts_info_footer .h3, .subscribe_news .h3').click('click',function(event){event.preventDefault();var arrow=$(this).parent().find('.toggle-xs');$(arrow.attr('data-target')).slideToggle();arrow.toggleClass('open');$(this).toggleClass('openh3')})}else{if($('form[name="cart_quantity"]').length!=0){var productHeader=$('.p_header').offset().top;$(document).on("scroll",function(){if($(document).scrollTop()>productHeader){$(".p_header").removeClass("p_header_rel").addClass("p_header_fix");$("main").css('margin-top','160px')}else{if($('.p_header').hasClass('p_header_fix')){$(".p_header").removeClass("p_header_fix").addClass("p_header_rel");$("main").css('margin-top',0)}}})}}
$('.go-back-xs').on('click',function(e){$(this).parent('div.submenu-list').removeClass('opened')});initScrollBar('.thumbs_row','false');$('.color_attributes input').on("click",function(e){initScrollBar('.thumbs_row','false')});$('[data-toggle="popover"]').on("click",function(e){e.preventDefault()});$(".input_select_all").on("click",function(){$(this).select()});$('.stop_propagation').on('click',function(e){e.stopPropagation()});$('.mainpage-categories-tabs a[data-toggle="tab"]').on('show.bs.tab',function(){$('.mainpage-categories-tabs .tab-content').css('opacity','0.05');$('.tab-loader').removeClass('hidden');var fName=$(this).data('file');var tabHref=$(this).attr('href');var findWidthToUnveil;var html='';$.get('/ajax_mainpage_tabs.php?fName='+fName,function(data){var ajax_globals=data.globals;$.each(data,function(k,v){if(v.product_image&&!findWidthToUnveil){findWidthToUnveil=v.product_image.split('&')[1].split('=')[1]}
if(k!='globals'){html+=draw_product_block(v,ajax_globals)}});$(tabHref).html('<div class="products-slider-block"><div class="row row_catalog_products"><div id="'+fName+'">'+html+'</div></div></div>');if(findWidthToUnveil){findWidthToUnveil=0}
createSliderForCategoryTabs(fName,ajax_globals);$('.mainpage-categories-tabs .tab-content').css('opacity','1');$('.tab-loader').addClass('hidden')},'json')});$('.quantity-selector-mask>input.qty').on('change input',function(){$('.p_info_item>[name="cart_quantity"]').val($(this).val())});if($('.mainpage-categories-tabs .tab-content .product_slider').length>0){var fName=$('.mainpage-categories-tabs .nav-tabs li.active a').data('file');$.get('/ajax_mainpage_tabs.php?fName='+fName,function(data){var firstTabId=$('.mainpage-categories-tabs .tab-content .product_slider').eq(0).attr('id');var ajax_globals=data.globals;createSliderForCategoryTabs(firstTabId,ajax_globals)},'json')}
$(document).on('change','#show_coupon',function(){if($(this).prop("checked")){$(this).closest('.coupon_block').find('.set_coupon').slideDown(200)}else{$(this).closest('.coupon_block').find('.set_coupon').slideUp(200)}});$(document).on('click','.proceed_btn ',function(){var collapse_wrapper=$(this).closest('.collapse_wrapper');collapse_wrapper.removeClass('open');collapse_wrapper.find('.edit_block').fadeIn();if(typeof checkout!=='undefined'){checkoutCollapsedTab(this.dataset.target,!1)}
disableCheckoutButton();if(!collapse_wrapper.next('.collapse_wrapper').hasClass('open')){collapse_wrapper.next('.collapse_wrapper').find('.collapse_wrapper_info').hide();collapse_wrapper.next('.collapse_wrapper').addClass('open');collapse_wrapper.next('.collapse_wrapper').find('.collapse').collapse('show');collapse_wrapper.next('.collapse_wrapper').find('.edit_block').fadeOut()}});$(document).on('click','.edit_block ',function(){$('.collapse_wrapper_info[data-parent="'+this.dataset.target+'"]').hide();$('.collapse_wrapper_billing_info[data-parent="'+this.dataset.target+'"]').hide();var collapse_wrapper=$(this).closest('.collapse_wrapper');collapse_wrapper.addClass('open');collapse_wrapper.find('.edit_block').fadeOut()});if($('.mob_short_cart').length>0){$('.checkout_scroll').on('click',function(){var bottom=$('.terms_of_use').offset().top;$('body, html').animate({scrollTop:bottom},1500)});$(document).on("scroll",function(){if($(window).scrollTop()==$(document).height()-$(window).height()){$('.mob_short_cart').fadeOut(200)}else{$('.mob_short_cart').fadeIn(200)}})}});function createSliderForCategoryTabs(fName,ajax_globals){$("#"+fName).owlCarousel({items:4,responsive:{0:{items:ajax_globals.blocks_num.xs,nav:!0},600:{items:ajax_globals.blocks_num.sm,nav:!0},1000:{items:4,nav:!0,loop:!0}},nav:!0,loop:!0,dots:!1,navText:['<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M217.9 256L345 129c9.4-9.4 9.4-24.6 0-33.9-9.4-9.4-24.6-9.3-34 0L167 239c-9.1 9.1-9.3 23.7-.7 33.1L310.9 417c4.7 4.7 10.9 7 17 7s12.3-2.3 17-7c9.4-9.4 9.4-24.6 0-33.9L217.9 256z"></path></svg>','<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M294.1 256L167 129c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.3 34 0L345 239c9.1 9.1 9.3 23.7.7 33.1L201.1 417c-4.7 4.7-10.9 7-17 7s-12.3-2.3-17-7c-9.4-9.4-9.4-24.6 0-33.9l127-127.1z"></path></svg>'],slideSpeed:200,});$("#"+fName).on('changed.owl.carousel',function(e){$("#"+fName+" img").unveil(500)});$('#'+fName+" img").unveil(500);$('#'+fName+" img").width('100%')}
var typingTimer;jQuery('body').on('change','input[name="cart_quantity[]"]',function(e){$(this).click(function(){$(this).parent().next('.product_total').find('.refresh_total').css('opacity','1');clearTimeout(typingTimer);typingTimer=setTimeout(doneTyping,1000)})}).on('keyup','input[name="cart_quantity[]"]',function(e){$(this).parent().next('.product_total').find('.refresh_total').css('opacity','1');if(e.keyCode>=48&&e.keyCode<=57||e.keyCode>=96&&e.keyCode<=105||e.keyCode==8||e.keyCode==46||e.keyCode==16||e.keyCode>=37&&e.keyCode<=40){clearTimeout(typingTimer);typingTimer=setTimeout(doneTyping,1000)}}).on('keydown','input[name="cart_quantity[]"]',function(e){$(this).parent().next('.product_total').find('.refresh_total').css('opacity','1');if(e.keyCode>=48&&e.keyCode<=57||e.keyCode>=96&&e.keyCode<=105||e.keyCode==8||e.keyCode==46||e.keyCode==16||e.keyCode>=37&&e.keyCode<=40){clearTimeout(typingTimer)}});function doneTyping(){jQuery("#popup_cart_form").ajaxSubmit({target:'#modal_cart_popup .modal-body',success:showPopupResponse});$('.refresh_total').css('opacity','0')}
$(document).ready(function(){$('select[name="currency"]').selectize({hideSelected:!0,maxItems:1,dropdownDirection:"up"})});Selectize.define('dropdown_direction',function(options){var self=this;options=$.extend({direction:self.settings.dropdownDirection||'auto'},options);this.positionDropdown=(function(){return function(){var $control=this.$control;var $dropdown=this.$dropdown;var p=getPositions();var direction=getDropdownDirection(p);if(direction==='up'){$dropdown.addClass('direction-up').removeClass('direction-down')}else{$dropdown.addClass('direction-down').removeClass('direction-up')}
$control.attr('data-dropdown-direction',direction);var isParentBody=this.settings.dropdownParent==='body';var offset=isParentBody?$control.offset():$control.position();var fittedHeight;switch(direction){case 'up':offset.top-=p.dropdown.height;if(p.dropdown.height>p.control.above){fittedHeight=p.control.above-15}
break;case 'down':offset.top+=p.control.height;if(p.dropdown.height>p.control.below){fittedHeight=p.control.below-15}
break}
if(fittedHeight){this.$dropdown_content.css({'max-height':fittedHeight})}
this.$dropdown.css({width:$control.outerWidth(),top:offset.top,left:offset.left})}})();function getDropdownDirection(positions){var direction=options.direction;if(direction==='auto'){if(positions.control.below>positions.dropdown.height){direction='down'}else{direction=(positions.control.above>positions.control.below)?'up':'down'}}
return direction}
function getPositions(){var $control=self.$control;var $window=$(window);var control_height=$control.outerHeight(!1);var control_above=$control.offset().top-$window.scrollTop();var control_below=$window.height()-control_above-control_height;var dropdown_height=self.$dropdown.outerHeight(!1);return{control:{height:control_height,above:control_above,below:control_below},dropdown:{height:dropdown_height}}}});(function(global,factory){typeof exports==='object'&&typeof module!=='undefined'?module.exports=factory():typeof define==='function'&&define.amd?define(factory):(global.SimpleBar=factory())}(this,(function(){'use strict';var _isObject=function(it){return typeof it==='object'?it!==null:typeof it==='function'};var _anObject=function(it){if(!_isObject(it))throw TypeError(it+' is not an object!');return it};var _fails=function(exec){try{return!!exec()}catch(e){return!0}};var _descriptors=!_fails(function(){return Object.defineProperty({},'a',{get:function(){return 7}}).a!=7});var commonjsGlobal=typeof window!=='undefined'?window:typeof global!=='undefined'?global:typeof self!=='undefined'?self:{};function createCommonjsModule(fn,module){return module={exports:{}},fn(module,module.exports),module.exports}
...
if(!_this.isWithinBounds(_this.axis.x.track.rect)){_this.axis.x.scrollbar.el.classList.remove(_this.classNames.visible);_this.axis.x.isVisible=!1}};this.onPointerEvent=function(e){var isWithinBoundsY,isWithinBoundsX;if(_this.axis.x.isOverflowing||_this.axis.x.forceVisible){isWithinBoundsX=_this.isWithinBounds(_this.axis.x.scrollbar.rect)}
...
return SimpleBar})));var compareFlag=!1;jQuery(document).ready(function(){$(document).on('click','.compare_button',function(event){if(event.target.parentElement.tagName==='A'&&TEMPLATE_NAME==='default'){window.location=event.target.parentElement.href;return!1}
...
for(var tagIndex=0;tagIndex<formElements.length;tagIndex++){for(var elementIndex=0;elementIndex<formElements[tagIndex].length;elementIndex++){formElements[tagIndex][elementIndex].setAttribute('disabled',!0)}};makeJSConstantsFromJson();function gtag(){return!1};function ge(){return!1};function fbq(){return!1};;;$('.ajax-module-box').each(function(){mainPageModules.push($(this).attr('data-module-id'))});makeMainSlider();if($(window).width()>'991'){setTimeout(function(){$('.custom_panel_block').addClass('visible');$('.open_custom_panel_btn').removeClass('anim')},500)}else{$('.open_custom_panel_btn').addClass('anim')}
blockUnveil(mainPageModules,100);$(window).scroll(function(){blockUnveil(mainPageModules,100);if(typeof window.loadFacebookWidget!='undefined'){loadFacebookWidget()}
checkIsCustomizationPanelVisible();checkAndAddMainStyles()});$(window).mousemove(function(){checkIsCustomizationPanelVisible();checkAndAddMainStyles()});function includeRecaptchaFile(){$.getScript("https://www.google.com/recaptcha/api.js")}
function reCaptchaCallback(callback){$.ajax({url:"./ext/recaptcha/recaptcha.php",dataType:"json",method:"post",data:{"action":"checkResponseToken","token":callback}}).done(function(response){})};if(typeof includeRecaptchaFile=="function"&&(page_name=="create_account"||page_name=="contact_us")){includeRecaptchaFile()};var loadFacebookWidgetFlag=!1;function loadFacebookWidget(){if(IS_MOBILE=="0"&&!loadFacebookWidgetFlag){loadFacebookWidgetFlag=!0;$.getScript("//connect.facebook.net/en_EN/sdk.js",function(){FB.init({appId:"1849675378584621",xfbml:!0,version:"v3.2"})})}};var jivositeFlag=!1;function showJivoChat(){if(!jivositeFlag){jivositeFlag=!0;setTimeout(function(){(function(){document.jivositeloaded=0;var widget_id='YGWwF0bMIZ';var d=document;var w=window;function l(){var s=d.createElement('script');s.type='text/javascript';s.async=!0;s.src='//code.jivosite.com/script/widget/'+widget_id;var ss=document.getElementsByTagName('script')[0];ss.parentNode.insertBefore(s,ss)}
...
if(page_name=='create_account_success'){doHookie('complete_registration')};function make_featured_slider(){var sliderObject=document.getElementById("featured");var itemsCount=$(">div",sliderObject).length;var it0=2;var it600=2;var it992=3;var it1200=4;var it1600=6;var navValue0=it0<itemsCount;var navValue600=it600<itemsCount;var navValue992=it992<itemsCount;var navValue1200=it1200<itemsCount;var navValue1600=it1600<itemsCount;$("#featured").owlCarousel({items:4,responsive:{0:{items:it0,nav:navValue0},600:{items:it600,nav:navValue600},992:{items:it992,nav:navValue992,loop:!0},1200:{items:it1200,nav:navValue1200,loop:!0},1600:{items:it1600,nav:navValue1600,loop:!0}},loop:!0,margin:0,dots:!1,onInitialized:setTimeout(function(){$(".product_slider ").css('overflow','visible')},500),onTranslated:function(e){$("#featured").find(".active img").unveil(100,addAnimClassToImg)},navText:['<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M217.9 256L345 129c9.4-9.4 9.4-24.6 0-33.9-9.4-9.4-24.6-9.3-34 0L167 239c-9.1 9.1-9.3 23.7-.7 33.1L310.9 417c4.7 4.7 10.9 7 17 7s12.3-2.3 17-7c9.4-9.4 9.4-24.6 0-33.9L217.9 256z"></path></svg>','<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M294.1 256L167 129c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.3 34 0L345 239c9.1 9.1 9.3 23.7.7 33.1L201.1 417c-4.7 4.7-10.9 7-17 7s-12.3-2.3-17-7c-9.4-9.4-9.4-24.6 0-33.9l127-127.1z"></path></svg>'],slideSpeed:200,})}
jQuery(document).ready(function(){make_featured_slider()});function make_most_viewed_slider(){var sliderObject=document.getElementById("most_viewed");var itemsCount=$(">div",sliderObject).length;var it0=2;var it600=2;var it992=3;var it1200=4;var it1600=6;var navValue0=it0<itemsCount;var navValue600=it600<itemsCount;var navValue992=it992<itemsCount;var navValue1200=it1200<itemsCount;var navValue1600=it1600<itemsCount;$("#most_viewed").owlCarousel({items:4,responsive:{0:{items:it0,nav:navValue0},600:{items:it600,nav:navValue600},992:{items:it992,nav:navValue992,loop:!0},1200:{items:it1200,nav:navValue1200,loop:!0},1600:{items:it1600,nav:navValue1600,loop:!0}},loop:!0,margin:0,dots:!1,onInitialized:setTimeout(function(){$(".product_slider ").css('overflow','visible')},500),onTranslated:function(e){$("#most_viewed").find(".active img").unveil(100,addAnimClassToImg)},navText:['<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M217.9 256L345 129c9.4-9.4 9.4-24.6 0-33.9-9.4-9.4-24.6-9.3-34 0L167 239c-9.1 9.1-9.3 23.7-.7 33.1L310.9 417c4.7 4.7 10.9 7 17 7s12.3-2.3 17-7c9.4-9.4 9.4-24.6 0-33.9L217.9 256z"></path></svg>','<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M294.1 256L167 129c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.3 34 0L345 239c9.1 9.1 9.3 23.7.7 33.1L201.1 417c-4.7 4.7-10.9 7-17 7s-12.3-2.3-17-7c-9.4-9.4-9.4-24.6 0-33.9l127-127.1z"></path></svg>'],slideSpeed:200,})}
jQuery(document).ready(function(){make_most_viewed_slider()});function make_specials_slider(){var sliderObject=document.getElementById("specials");var itemsCount=$(">div",sliderObject).length;var it0=2;var it600=2;var it992=3;var it1200=4;var it1600=6;var navValue0=it0<itemsCount;var navValue600=it600<itemsCount;var navValue992=it992<itemsCount;var navValue1200=it1200<itemsCount;var navValue1600=it1600<itemsCount;$("#specials").owlCarousel({items:4,responsive:{0:{items:it0,nav:navValue0},600:{items:it600,nav:navValue600},992:{items:it992,nav:navValue992,loop:!0},1200:{items:it1200,nav:navValue1200,loop:!0},1600:{items:it1600,nav:navValue1600,loop:!0}},loop:!0,margin:0,dots:!1,onInitialized:setTimeout(function(){$(".product_slider ").css('overflow','visible')},500),onTranslated:function(e){$("#specials").find(".active img").unveil(100,addAnimClassToImg)},navText:['<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M217.9 256L345 129c9.4-9.4 9.4-24.6 0-33.9-9.4-9.4-24.6-9.3-34 0L167 239c-9.1 9.1-9.3 23.7-.7 33.1L310.9 417c4.7 4.7 10.9 7 17 7s12.3-2.3 17-7c9.4-9.4 9.4-24.6 0-33.9L217.9 256z"></path></svg>','<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M294.1 256L167 129c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.3 34 0L345 239c9.1 9.1 9.3 23.7.7 33.1L201.1 417c-4.7 4.7-10.9 7-17 7s-12.3-2.3-17-7c-9.4-9.4-9.4-24.6 0-33.9l127-127.1z"></path></svg>'],slideSpeed:200,})}
jQuery(document).ready(function(){make_specials_slider()});$(document).ready(function(){doHookie('page_view');if(page_name=='checkout'){$('#pageContentContainer').show();onePage.initCheckout()}setTimeout(function(){$.ajaxSetup({cache:!0});$(".youtube_iframe").each(function(){$(this).attr("src",$(this).attr("data-src"))})},4000)})